...
!function(t,e,n,i){function o(e,i){this.w=t(n),this.el=t(e),this.options=t.extend({},l,i),this.init()}var a="ontouchstart"in n,s=function(){var t=n.createElement("div"),i=n.documentElement;if(!("pointerEvents"in t.style))return!1;t.style.pointerEvents="auto",t.style.pointerEvents="x",i.appendChild(t);var o=e.getComputedStyle&&"auto"===e.getComputedStyle(t,"").pointerEvents;return i.removeChild(t),!!o}(),l={listNodeName:"ol",itemNodeName:"li",rootClass:"dd",listClass:"dd-list",itemClass:"dd-item",dragClass:"dd-dragel",handleClass:"dd-handle",collapsedClass:"dd-collapsed",placeClass:"dd-placeholder",noDragClass:"dd-nodrag",emptyClass:"dd-empty",expandBtnHTML:'<button data-action="expand" type="button">Expand</button>',collapseBtnHTML:'<button data-action="collapse" type="button">Collapse</button>',group:0,maxDepth:5,threshold:20};o.prototype={init:function(){var n=this;n.reset(),n.el.data("nestable-group",this.options.group),n.placeEl=t('<div class="'+n.options.placeClass+'"/>'),t.each(this.el.find(n.options.itemNodeName),function(e,i){n.setParent(t(i))}),n.el.on("click","button",function(e){if(!n.dragEl){var i=t(e.currentTarget),o=i.data("action"),a=i.parent(n.options.itemNodeName);"collapse"===o&&n.collapseItem(a),"expand"===o&&n.expandItem(a)}});var i=function(e){var i=t(e.target);if(!i.hasClass(n.options.handleClass)){if(i.closest("."+n.options.noDragClass).length)return;i=i.closest("."+n.options.handleClass)}i.length&&!n.dragEl&&(n.isTouch=/^touch/.test(e.type),n.isTouch&&1!==e.touches.length||(e.preventDefault(),n.dragStart(e.touches?e.touches[0]:e)))},o=function(t){n.dragEl&&(t.preventDefault(),n.dragMove(t.touches?t.touches[0]:t))},s=function(t){n.dragEl&&(t.preventDefault(),n.dragStop(t.touches?t.touches[0]:t))};a&&(n.el[0].addEventListener("touchstart",i,!1),e.addEventListener("touchmove",o,!1),e.addEventListener("touchend",s,!1),e.addEventListener("touchcancel",s,!1)),n.el.on("mousedown",i),n.w.on("mousemove",o),n.w.on("mouseup",s)},serialize:function(){var e,n=0,i=this;return step=function(e,n){var o=[],a=e.children(i.options.itemNodeName);return a.each(function(){var e=t(this),a=t.extend({},e.data()),s=e.children(i.options.listNodeName);s.length&&(a.children=step(s,n+1)),o.push(a)}),o},e=step(i.el.find(i.options.listNodeName).first(),n)},serialise:function(){return this.serialize()},reset:function(){this.mouse={offsetX:0,offsetY:0,startX:0,startY:0,lastX:0,lastY:0,nowX:0,nowY:0,distX:0,distY:0,dirAx:0,dirX:0,dirY:0,lastDirX:0,lastDirY:0,distAxX:0,distAxY:0},this.isTouch=!1,this.moving=!1,this.dragEl=null,this.dragRootEl=null,this.dragDepth=0,this.hasNewRoot=!1,this.pointEl=null},expandItem:function(t){t.removeClass(this.options.collapsedClass),t.children('[data-action="expand"]').hide(),t.children('[data-action="collapse"]').show(),t.children(this.options.listNodeName).show()},collapseItem:function(t){var e=t.children(this.options.listNodeName);e.length&&(t.addClass(this.options.collapsedClass),t.children('[data-action="collapse"]').hide(),t.children('[data-action="expand"]').show(),t.children(this.options.listNodeName).hide())},expandAll:function(){var e=this;e.el.find(e.options.itemNodeName).each(function(){e.expandItem(t(this))})},collapseAll:function(){var e=this;e.el.find(e.options.itemNodeName).each(function(){e.collapseItem(t(this))})},setParent:function(e){e.children(this.options.listNodeName).length&&(e.prepend(t(this.options.expandBtnHTML)),e.prepend(t(this.options.collapseBtnHTML))),e.children('[data-action="expand"]').hide()},unsetParent:function(t){t.removeClass(this.options.collapsedClass),t.children("[data-action]").remove(),t.children(this.options.listNodeName).remove()},dragStart:function(e){var o=this.mouse,a=t(e.target),s=a.closest(this.options.itemNodeName);this.placeEl.css("height",s.height()),o.offsetX=e.offsetX!==i?e.offsetX:e.pageX-a.offset().left,o.offsetY=e.offsetY!==i?e.offsetY:e.pageY-a.offset().top,o.startX=o.lastX=e.pageX,o.startY=o.lastY=e.pageY,this.dragRootEl=this.el,this.dragEl=t(n.createElement(this.options.listNodeName)).addClass(this.options.listClass+" "+this.options.dragClass),this.dragEl.css("width",s.width()),s.after(this.placeEl),s[0].parentNode.removeChild(s[0]),s.appendTo(this.dragEl),t(n.body).append(this.dragEl),this.dragEl.css({left:e.pageX-o.offsetX,top:e.pageY-o.offsetY});var l,r,d=this.dragEl.find(this.options.itemNodeName);for(l=0;l<d.length;l++)r=t(d[l]).parents(this.options.listNodeName).length,r>this.dragDepth&&(this.dragDepth=r)},dragStop:function(t){var e=this.dragEl.children(this.options.itemNodeName).first();e[0].parentNode.removeChild(e[0]),this.placeEl.replaceWith(e),this.dragEl.remove(),this.el.trigger("change"),this.hasNewRoot&&this.dragRootEl.trigger("change"),this.reset()},dragMove:function(i){var o,a,l,r,d,c=this.options,p=this.mouse;this.dragEl.css({left:i.pageX-p.offsetX,top:i.pageY-p.offsetY}),p.lastX=p.nowX,p.lastY=p.nowY,p.nowX=i.pageX,p.nowY=i.pageY,p.distX=p.nowX-p.lastX,p.distY=p.nowY-p.lastY,p.lastDirX=p.dirX,p.lastDirY=p.dirY,p.dirX=0===p.distX?0:p.distX>0?1:-1,p.dirY=0===p.distY?0:p.distY>0?1:-1;var h=Math.abs(p.distX)>Math.abs(p.distY)?1:0;if(!p.moving)return p.dirAx=h,void(p.moving=!0);p.dirAx!==h?(p.distAxX=0,p.distAxY=0):(p.distAxX+=Math.abs(p.distX),0!==p.dirX&&p.dirX!==p.lastDirX&&(p.distAxX=0),p.distAxY+=Math.abs(p.distY),0!==p.dirY&&p.dirY!==p.lastDirY&&(p.distAxY=0)),p.dirAx=h,p.dirAx&&p.distAxX>=c.threshold&&(p.distAxX=0,l=this.placeEl.prev(c.itemNodeName),p.distX>0&&l.length&&!l.hasClass(c.collapsedClass)&&(o=l.find(c.listNodeName).last(),d=this.placeEl.parents(c.listNodeName).length,d+this.dragDepth<=c.maxDepth&&(o.length?(o=l.children(c.listNodeName).last(),o.append(this.placeEl)):(o=t("<"+c.listNodeName+"/>").addClass(c.listClass),o.append(this.placeEl),l.append(o),this.setParent(l)))),p.distX<0&&(r=this.placeEl.next(c.itemNodeName),r.length||(a=this.placeEl.parent(),this.placeEl.closest(c.itemNodeName).after(this.placeEl),a.children().length||this.unsetParent(a.parent()))));var u=!1;if(s||(this.dragEl[0].style.visibility="hidden"),this.pointEl=t(n.elementFromPoint(i.pageX-n.body.scrollLeft,i.pageY-(e.pageYOffset||n.documentElement.scrollTop))),s||(this.dragEl[0].style.visibility="visible"),this.pointEl.hasClass(c.handleClass)&&(this.pointEl=this.pointEl.parent(c.itemNodeName)),this.pointEl.hasClass(c.emptyClass))u=!0;else if(!this.pointEl.length||!this.pointEl.hasClass(c.itemClass))return;var f=this.pointEl.closest("."+c.rootClass),m=this.dragRootEl.data("nestable-id")!==f.data("nestable-id");if(!p.dirAx||m||u){if(m&&c.group!==f.data("nestable-group"))return;if(d=this.dragDepth-1+this.pointEl.parents(c.listNodeName).length,d>c.maxDepth)return;var q=i.pageY<this.pointEl.offset().top+this.pointEl.height()/2;a=this.placeEl.parent(),u?(o=t(n.createElement(c.listNodeName)).addClass(c.listClass),o.append(this.placeEl),this.pointEl.replaceWith(o)):q?this.pointEl.before(this.placeEl):this.pointEl.after(this.placeEl),a.children().length||this.unsetParent(a.parent()),this.dragRootEl.find(c.itemNodeName).length||this.dragRootEl.append('<div class="'+c.emptyClass+'"/>'),m&&(this.dragRootEl=f,this.hasNewRoot=this.el[0]!==this.dragRootEl[0])}}},t.fn.nestable=function(e){var n=this,i=this;return n.each(function(){var n=t(this).data("nestable");n?"string"==typeof e&&"function"==typeof n[e]&&(i=n[e]()):(t(this).data("nestable",new o(this,e)),t(this).data("nestable-id",(new Date).getTime()))}),i||n}}(window.jQuery||window.Zepto,window,document);var _ignorehash,admin={wysiwyg:{add:function(t,e){e=e||{};var n={selector:"#"+t,content_css:"./sites/default/css/styles.css",plugins:["advlist autolink link image lists charmap preview hr anchor","searchreplace wordcount visualblocks visualchars code fullscreen media nonbreaking","save table contextmenu directionality paste textcolor template imagetools importcss"],importcss_append:!0,importcss_groups:[{title:"Other styles"}],paste_as_text:!0,toolbar:"undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image anchor | print preview media fullpage | forecolor backcolor | code",image_advtab:!0,removed_menuitems:"newdocument",templates:[{title:"download",content:"[[download]]editme[[/download]]"},{title:"fig",content:'[[fig path="./sites/default/images/"]]caption[[/fig]]'},{title:"gallery",content:"[[gallery]]editme[[/gallery]]"},{title:"link",content:"[[link]]editme[[/link]]"},{title:"map",content:"[[map]]editme[[/map]]"},{title:"userform",content:"[[userform]]editme[[/userform]]"},{title:"vimeo",content:"[[vimeo]]editme[[/vimeo]]"},{title:"youtube",content:"[[youtube]]editme[[/youtube]]"}]};$.extend(n,e),tinymce.init(n)},preSave:function(){},setValue:function(t,e){tinymce.get(t).setContent(e)}},removeNotValid:function(t,e){e=e||{};var n="_,=.\\s\\?'\"\\-$:;’°“”";e.permit&&$.each(e.permit,function(t,e){n=n.replace(e,"")}),t.on("keyup",function(t){if(13!==t.keyCode&&37!==t.keyCode&&38!==t.keyCode&&39!==t.keyCode&&40!==t.keyCode&&8!==t.keyCode&&46!==t.keyCode&&16!==t.keyCode&&17!==t.keyCode&&18!==t.keyCode&&91!==t.keyCode&&93!==t.keyCode){var i=$(this).val();if(i&&""!==i){var o=i.replace(new RegExp("(["+n+"])","gi"),e.replace?e.replace:"");o=e.toLower?o.toLowerCase():o,$(this).val(o)}}}),e.replace&&t.on("change",function(){var t=$(this).val();t=t.replace(new RegExp(e.replace+"+","gi"),e.replace).replace(new RegExp(e.replace+"$"),"").replace(new RegExp("^"+e.replace),""),$(this).val(t)})},upload:function(t,e,n){n=n||{},new qq.FileUploader({element:t,action:e,allowedExtensions:n.allowedExtensions?n.allowedExtensions:[],sizeLimit:n.sizeLimit?n.sizeLimit:0,minSizeLimit:n.minSizeLimit?n.minSizeLimit:0,onComplete:function(t,e,i){return n.loaded?n.loaded(t,e,i):!1}})},filterList:function(t,e,n){t&&""!==t?n?(e.find(".search-text:not(:Contains("+t+"))").parents(".search-container").fadeOut(),e.find(".search-text:Contains("+t+")").parents(".search-container").fadeOut()):(e.find(".search-text:not(:Contains("+t+"))").fadeOut(),e.find(".search-text:Contains("+t+")").fadeIn()):e.find("."+(n?"search-container":"search-text")).fadeIn()},dialog:function(t){$("#modal").length>0&&$("#modal").modal("hide");var e=$("<div />").attr("id","modal").addClass("modal fade").append('<div class="modal-dialog"><div class="modal-content">'+(t.title?'<div class="modal-header"><h4>'+t.title+"</h4></div>":"")+"</div></div>").appendTo("body");t.width&&e.css({width:t.width,"margin-left":"-"+t.width/2+"px"});var n=$("<div />").addClass("modal-body").appendTo(e.find("div.modal-content"));if(t.buttons&&"object"==typeof t.buttons){var i=$("<div />").addClass("modal-footer").appendTo(e.find("div.modal-content"));$.each(t.buttons,function(t,n){var o=$("<a />").addClass("btn"+(n.addclass?" "+n.addclass:" btn-primary")).html((n.glyphicon?'<i class="glyphicon glyphicon-'+n.glyphicon+'"></i> ':"")+n.text);n.href&&o.attr("href",n.href),n.click&&("close"===n.click?o.attr("data-dismiss","modal"):o.click(function(){n.click(e)})),"close"===n.action&&o.attr("data-dismiss","modal"),o.appendTo(i)})}e.modal({keyboard:!0}),e.on("hidden.bs.modal",function(){$("body").removeClass("modal-open"),e.remove()}),t.html?(n.html(t.html),t.loaded&&t.loaded(n)):t.obj&&t.method&&(e.find(".modal-body").html('<i class="icon ion-load-c ion-loading-c" style="font-size: 3em;"></i>'),$.ajax({type:t.post?"POST":"GET",url:"controller.php?obj="+t.obj+"&method="+t.method+(t.param?"&param[]="+t.param.join("&param[]="):""),data:t.post}).done(function(n){e.find(".modal-body").html(n),t.loaded&&t.loaded(e)}).fail(function(){e.find(".modal-body").html('<p class="text-danger">'+admin.tr("error_check_log")+"</p>")}))},message:function(t,e,n,i){new PNotify({title:n?n:!1,text:t,type:e?e:!1,hide:i?!1:!0,styling:"bootstrap3"})},tabs:{tab:"",set:function(t){"string"==typeof t?this.tab=$(t):this.tab=t},start:function(){tab=this.tab,tab.find("a").click(function(t){t.preventDefault(),$(this).tab("show")}),tab.find("button.close").click(function(t){var e=$(this).parents("li");return admin.tabs.closeTab(e),!1})},add:function(t){var e=t.title?t.title:"",n=this.tab,i=Math.floor(1e3*Math.random())+""+n.find("li").length;if(this.tab.append('<li><a href="#added'+i+'">'+e+'<button class="close" type="button">×</button></a></li>'),t.html)this.tab.next("div.tab-content").append('<div class="tab-pane" id="added'+i+'">'+t.html+"</div>"),this.start(n),this.tab.find("li a:last").tab("show"),this.tab.find("li:last").data("url",location.hash.substring(1)),this.tab.find("li:last").data("opts",t);else{if(!t.obj||!t.method)return!1;admin.tabs.tab.next("div.tab-content").append('<div class="tab-pane" id="added'+i+'"><i class="icon ion-load-c ion-loading-c" style="font-size: 3em;"></i></div>'),admin.tabs.start(n),admin.tabs.tab.find("li a:last").tab("show"),this.tab.find("li:last").data("url",location.hash.substring(1)),this.tab.find("li:last").data("opts",t),$.ajax({type:t.post?"POST":"GET",url:"controller.php?obj="+t.obj+"&method="+t.method+(t.param?"&param[]="+t.param.join("&param[]="):""),data:t.post}).done(function(t){$("#added"+i).html(t)}).fail(function(){$("#added"+i).html('<p class="text-danger">'+admin.tr("error_check_log")+"</p>")})}this.tab.find("li:last").on("click",function(){_ignorehash=!0,location.hash="#"+$(this).data("url")})},reloadActive:function(){this.reload()},reloadThis:function(t){t instanceof jQuery||(t=$(t));var e=t.parents(".tab-pane").index();e&&this.reload(e)},reload:function(t){var e,n;t?(e=$("div.tab-content .tab-pane").get(t),e=$(e),n=$(tab.find("li").get(t)).data("opts")):(e=$("div.tab-content div.active"),n=tab.find("li.active").data("opts"));var i="controller.php?obj="+n.obj+"&method="+n.method+(n.param?"&param[]="+n.param.join("&param[]="):"");e.html('<i class="icon ion-load-c ion-loading-c" style="font-size: 3em;"></i>'),$.ajax({url:i,data:n.data}).done(function(t){e.html(t)}).fail(function(){e.html('<p class="text-danger">'+admin.tr("error_check_log")+"</p>")})},closeActive:function(t){var e=tab.find("li.active");admin.tabs.closeTab(e,t)},closeTab:function(t,e){if(1===tab.find("li").length)return void(e&&(location.hash="#"+e));if(t.hasClass("active"))if(e){var n=location.hash.substr(1);if(n===e)return void admin.tabs.reloadActive();location.hash="#"+e,tab.find("li a:last").tab("show"),$("#"+t.find("a").attr("href").replace("#","")).remove(),t.remove()}else{$("#"+t.find("a").attr("href").replace("#","")).remove(),t.remove(),tab.find("li a:last").tab("show");var i=tab.find("li:last").data("url");i&&"undefined"!==i?(_ignorehash=!0,location.hash="#"+i):location.hash="#"}else t.remove()}},tr:function(t){return lang[t]?lang[t]:t},media:{go2dir:function(t){admin.tabs.closeActive("media/all/"+t)},deleteDir:function(t){$.get("controller.php?obj=media_ctrl&method=delete&param[]="+t,function(t){admin.message(t.text,t.status),"success"==t.status&&admin.media.go2dir(t.new_path)},"json")},deleteFile:function(t){admin.dialog({title:admin.tr("pay_attention_please"),html:admin.tr("confirm_delete_file"),buttons:[{text:'<i class="glyphicon glyphicon-trash"></i>  '+admin.tr("delete"),addclass:"btn-danger",action:"close",click:function(){$.get("controller.php?obj=media_ctrl&method=delete&param[]="+t,function(t){admin.message(t.text,t.status),"success"==t.status&&admin.tabs.closeActive("media/all/"+t.new_path)},"json")}},{text:admin.tr("close"),action:"close"}]})},filterDir:function(t,e){t?($("#media-"+e+" div.searcheable:not(:Contains("+t+"))").parents("li").fadeOut(),$("#media-"+e+" div.searcheable:Contains("+t+")").parents("li").fadeIn()):$("#media-"+e+" li").fadeIn()}}};$(function(){admin.tabs.set("#tabs"),admin.tabs.start(),$(window).on("hashchange",function(t){if(_ignorehash)return void(_ignorehash=!1);var e=location.hash.substring(1);if(e&&!e.match(/nt-/)){var n=e.split("/");admin.tabs.add({title:n[0]+"/"+n[1]+(n[2]?"/"+n[2].substr(0,5)+"...":""),obj:n[0]+"_ctrl",method:n[1],param:n.slice(2)})}}).trigger("hashchange")}),jQuery.expr[":"].Contains=function(t,e,n){return(t.textContent||t.innerText||"").toUpperCase().indexOf(n[3].toUpperCase())>=0},$("a.ftpopover").popover({html:!0}),$(document).ready(function(){$(".toggleMenu").on("click",function(t){$("#menu, #content").toggleClass("shown"),"#"===$(this).attr("href")&&t.preventDefault()}),$("#content").on("click",function(){$("#menu, #content").removeClass("shown"),$("#menu ul.sub").removeClass("show")}),$("#menu a").on("click",function(){"#"!==$(this).attr("href")&&($("#menu ul.sub").removeClass("show"),$("#menu, #content").removeClass("shown"))}),$("#menu a.sub-toggle").on("click",function(t){return $(this).next("ul.sub").toggleClass("show"),$("#menu ul.sub").not($(this).next("ul.sub")).removeClass("show"),t.preventDefault(),!1}),"ontouchstart"in document.documentElement||$('[data-toggle="tooltip"]').tooltip()});var qq=qq||{};qq.extend=function(t,e){for(var n in e)t[n]=e[n]},qq.indexOf=function(t,e,n){if(t.indexOf)return t.indexOf(e,n);n=n||0;var i=t.length;for(0>n&&(n+=i);i>n;n++)if(n in t&&t[n]===e)return n;return-1},qq.getUniqueId=function(){var t=0;return function(){return t++}}(),qq.attach=function(t,e,n){t.addEventListener?t.addEventListener(e,n,!1):t.attachEvent&&t.attachEvent("on"+e,n)},qq.detach=function(t,e,n){t.removeEventListener?t.removeEventListener(e,n,!1):t.attachEvent&&t.detachEvent("on"+e,n)},qq.preventDefault=function(t){t.preventDefault?t.preventDefault():t.returnValue=!1},qq.insertBefore=function(t,e){e.parentNode.insertBefore(t,e)},qq.remove=function(t){t.parentNode.removeChild(t)},qq.contains=function(t,e){return t==e?!0:t.contains?t.contains(e):!!(8&e.compareDocumentPosition(t))},qq.toElement=function(){var t=document.createElement("div");return function(e){t.innerHTML=e;var n=t.firstChild;return t.removeChild(n),n}}(),qq.css=function(t,e){null!=e.opacity&&"string"!=typeof t.style.opacity&&"undefined"!=typeof t.filters&&(e.filter="alpha(opacity="+Math.round(100*e.opacity)+")"),qq.extend(t.style,e)},qq.hasClass=function(t,e){var n=new RegExp("(^| )"+e+"( |$)");return n.test(t.className)},qq.addClass=function(t,e){qq.hasClass(t,e)||(t.className+=" "+e)},qq.removeClass=function(t,e){var n=new RegExp("(^| )"+e+"( |$)");t.className=t.className.replace(n," ").replace(/^\s+|\s+$/g,"")},qq.setText=function(t,e){t.innerText=e,t.textContent=e},qq.children=function(t){for(var e=[],n=t.firstChild;n;)1==n.nodeType&&e.push(n),n=n.nextSibling;return e},qq.getByClass=function(t,e){if(t.querySelectorAll)return t.querySelectorAll("."+e);for(var n=[],i=t.getElementsByTagName("*"),o=i.length,a=0;o>a;a++)qq.hasClass(i[a],e)&&n.push(i[a]);return n},qq.obj2url=function(t,e,n){var i=[],o="&",a=function(t,n){var o=e?/\[\]$/.test(e)?e:e+"["+n+"]":n;"undefined"!=o&&"undefined"!=n&&i.push("object"==typeof t?qq.obj2url(t,o,!0):"[object Function]"===Object.prototype.toString.call(t)?encodeURIComponent(o)+"="+encodeURIComponent(t()):encodeURIComponent(o)+"="+encodeURIComponent(t))};if(!n&&e)o=/\?/.test(e)?/\?$/.test(e)?"":"&":"?",i.push(e),i.push(qq.obj2url(t));else if("[object Array]"===Object.prototype.toString.call(t)&&"undefined"!=typeof t)for(var s=0,l=t.length;l>s;++s)a(t[s],s);else if("undefined"!=typeof t&&null!==t&&"object"==typeof t)for(var s in t)a(t[s],s);else i.push(encodeURIComponent(e)+"="+encodeURIComponent(t));return i.join(o).replace(/^&/,"").replace(/%20/g,"+")};var qq=qq||{};qq.FileUploaderBasic=function(t){this._options={debug:!1,action:"/server/upload",params:{},button:null,multiple:!0,maxConnections:3,allowedExtensions:[],sizeLimit:0,minSizeLimit:0,onSubmit:function(t,e){},onProgress:function(t,e,n,i){},onComplete:function(t,e,n){},onCancel:function(t,e){},messages:{typeError:"{file} has invalid extension. Only {extensions} are allowed.",sizeError:"{file} is too large, maximum file size is {sizeLimit}.",minSizeError:"{file} is too small, minimum file size is {minSizeLimit}.",emptyError:"{file} is empty, please select files again without it.",onLeave:"The files are being uploaded, if you leave now the upload will be cancelled."},showMessage:function(t){alert(t)}},qq.extend(this._options,t),this._filesInProgress=0,this._handler=this._createUploadHandler(),this._options.button&&(this._button=this._createUploadButton(this._options.button)),this._preventLeaveInProgress()},qq.FileUploaderBasic.prototype={setParams:function(t){this._options.params=t},getInProgress:function(){return this._filesInProgress},_createUploadButton:function(t){var e=this;return new qq.UploadButton({element:t,multiple:this._options.multiple&&qq.UploadHandlerXhr.isSupported(),onChange:function(t){e._onInputChange(t)}})},_createUploadHandler:function(){var t,e=this;t=qq.UploadHandlerXhr.isSupported()?"UploadHandlerXhr":"UploadHandlerForm";var n=new qq[t]({debug:this._options.debug,action:this._options.action,maxConnections:this._options.maxConnections,onProgress:function(t,n,i,o){e._onProgress(t,n,i,o),e._options.onProgress(t,n,i,o)},onComplete:function(t,n,i){e._onComplete(t,n,i),e._options.onComplete(t,n,i)},onCancel:function(t,n){e._onCancel(t,n),e._options.onCancel(t,n)}});return n},_preventLeaveInProgress:function(){var t=this;qq.attach(window,"beforeunload",function(e){if(t._filesInProgress){var e=e||window.event;return e.returnValue=t._options.messages.onLeave,t._options.messages.onLeave}})},_onSubmit:function(t,e){this._filesInProgress++},_onProgress:function(t,e,n,i){},_onComplete:function(t,e,n){this._filesInProgress--,n.error&&this._options.showMessage(n.error)},_onCancel:function(t,e){this._filesInProgress--},_onInputChange:function(t){this._handler instanceof qq.UploadHandlerXhr?this._uploadFileList(t.files):this._validateFile(t)&&this._uploadFile(t),this._button.reset()},_uploadFileList:function(t){for(var e=0;e<t.length;e++)if(!this._validateFile(t[e]))return;for(var e=0;e<t.length;e++)this._uploadFile(t[e])},_uploadFile:function(t){var e=this._handler.add(t),n=this._handler.getName(e);this._options.onSubmit(e,n)!==!1&&(this._onSubmit(e,n),this._handler.upload(e,this._options.params))},_validateFile:function(t){var e,n;return t.value?e=t.value.replace(/.*(\/|\\)/,""):(e=null!=t.fileName?t.fileName:t.name,n=null!=t.fileSize?t.fileSize:t.size),this._isAllowedExtension(e)?0===n?(this._error("emptyError",e),!1):n&&this._options.sizeLimit&&n>this._options.sizeLimit?(this._error("sizeError",e),!1):n&&n<this._options.minSizeLimit?(this._error("minSizeError",e),!1):!0:(this._error("typeError",e),!1)},_error:function(t,e){function n(t,e){i=i.replace(t,e)}var i=this._options.messages[t];n("{file}",this._formatFileName(e)),n("{extensions}",this._options.allowedExtensions.join(", ")),n("{sizeLimit}",this._formatSize(this._options.sizeLimit)),n("{minSizeLimit}",this._formatSize(this._options.minSizeLimit)),this._options.showMessage(i)},_formatFileName:function(t){return t.length>33&&(t=t.slice(0,19)+"..."+t.slice(-13)),t},_isAllowedExtension:function(t){var e=-1!==t.indexOf(".")?t.replace(/.*[.]/,"").toLowerCase():"",n=this._options.allowedExtensions;if(!n.length)return!0;for(var i=0;i<n.length;i++)if(n[i].toLowerCase()==e)return!0;return!1},_formatSize:function(t){var e=-1;do t/=1024,e++;while(t>99);return Math.max(t,.1).toFixed(1)+["kB","MB","GB","TB","PB","EB"][e]}},qq.FileUploader=function(t){qq.FileUploaderBasic.apply(this,arguments),qq.extend(this._options,{element:null,listElement:null,template:'<div class="qq-uploader"><div class="qq-upload-drop-area"><span>Drop files here to upload</span></div><div class="qq-upload-button">Upload a file</div><ul class="qq-upload-list"></ul></div>',fileTemplate:'<li><span class="qq-upload-file"></span><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span><a class="qq-upload-cancel" href="#">Cancel</a><span class="qq-upload-failed-text">Failed</span></li>',classes:{button:"qq-upload-button",drop:"qq-upload-drop-area",dropActive:"qq-upload-drop-area-active",list:"qq-upload-list",file:"qq-upload-file",spinner:"qq-upload-spinner",size:"qq-upload-size",cancel:"qq-upload-cancel",success:"qq-upload-success",fail:"qq-upload-fail"}}),qq.extend(this._options,t),this._element=this._options.element,this._element.innerHTML=this._options.template,this._listElement=this._options.listElement||this._find(this._element,"list"),this._classes=this._options.classes,this._button=this._createUploadButton(this._find(this._element,"button")),this._bindCancelEvent(),this._setupDragDrop()},qq.extend(qq.FileUploader.prototype,qq.FileUploaderBasic.prototype),qq.extend(qq.FileUploader.prototype,{_find:function(t,e){var n=qq.getByClass(t,this._options.classes[e])[0];if(!n)throw new Error("element not found "+e);return n},_setupDragDrop:function(){var t=this,e=this._find(this._element,"drop"),n=new qq.UploadDropZone({element:e,onEnter:function(n){qq.addClass(e,t._classes.dropActive),n.stopPropagation()},onLeave:function(t){t.stopPropagation()},onLeaveNotDescendants:function(n){qq.removeClass(e,t._classes.dropActive)},onDrop:function(n){e.style.display="none",qq.removeClass(e,t._classes.dropActive),t._uploadFileList(n.dataTransfer.files)}});e.style.display="none",qq.attach(document,"dragenter",function(t){n._isValidFileDrag(t)&&(e.style.display="block")}),qq.attach(document,"dragleave",function(t){if(n._isValidFileDrag(t)){var i=document.elementFromPoint(t.clientX,t.clientY);i&&"HTML"!=i.nodeName||(e.style.display="none")}})},_onSubmit:function(t,e){qq.FileUploaderBasic.prototype._onSubmit.apply(this,arguments),this._addToList(t,e)},_onProgress:function(t,e,n,i){qq.FileUploaderBasic.prototype._onProgress.apply(this,arguments);var o=this._getItemByFileId(t),a=this._find(o,"size");a.style.display="inline";var s;s=n!=i?Math.round(n/i*100)+"% from "+this._formatSize(i):this._formatSize(i),qq.setText(a,s)},_onComplete:function(t,e,n){qq.FileUploaderBasic.prototype._onComplete.apply(this,arguments);var i=this._getItemByFileId(t);qq.remove(this._find(i,"cancel")),qq.remove(this._find(i,"spinner")),n.success?qq.addClass(i,this._classes.success):qq.addClass(i,this._classes.fail)},_addToList:function(t,e){var n=qq.toElement(this._options.fileTemplate);n.qqFileId=t;var i=this._find(n,"file");qq.setText(i,this._formatFileName(e)),this._find(n,"size").style.display="none",this._listElement.appendChild(n)},_getItemByFileId:function(t){for(var e=this._listElement.firstChild;e;){if(e.qqFileId==t)return e;e=e.nextSibling}},_bindCancelEvent:function(){var t=this,e=this._listElement;qq.attach(e,"click",function(e){e=e||window.event;var n=e.target||e.srcElement;if(qq.hasClass(n,t._classes.cancel)){qq.preventDefault(e);var i=n.parentNode;t._handler.cancel(i.qqFileId),qq.remove(i)}})}}),qq.UploadDropZone=function(t){this._options={element:null,onEnter:function(t){},onLeave:function(t){},onLeaveNotDescendants:function(t){},onDrop:function(t){}},qq.extend(this._options,t),this._element=this._options.element,this._disableDropOutside(),this._attachEvents()},qq.UploadDropZone.prototype={_disableDropOutside:function(t){qq.UploadDropZone.dropOutsideDisabled||(qq.attach(document,"dragover",function(t){t.dataTransfer&&(t.dataTransfer.dropEffect="none",t.preventDefault())}),qq.UploadDropZone.dropOutsideDisabled=!0)},_attachEvents:function(){var t=this;qq.attach(t._element,"dragover",function(e){if(t._isValidFileDrag(e)){var n=e.dataTransfer.effectAllowed;"move"==n||"linkMove"==n?e.dataTransfer.dropEffect="move":e.dataTransfer.dropEffect="copy",e.stopPropagation(),e.preventDefault()}}),qq.attach(t._element,"dragenter",function(e){t._isValidFileDrag(e)&&t._options.onEnter(e)}),qq.attach(t._element,"dragleave",function(e){if(t._isValidFileDrag(e)){t._options.onLeave(e);var n=document.elementFromPoint(e.clientX,e.clientY);qq.contains(this,n)||t._options.onLeaveNotDescendants(e)}}),qq.attach(t._element,"drop",function(e){t._isValidFileDrag(e)&&(e.preventDefault(),t._options.onDrop(e))})},_isValidFileDrag:function(t){var e=t.dataTransfer,n=navigator.userAgent.indexOf("AppleWebKit")>-1;return e&&"none"!=e.effectAllowed&&(e.files||!n&&e.types.contains&&e.types.contains("Files"))}},qq.UploadButton=function(t){this._options={element:null,multiple:!1,name:"file",onChange:function(t){},hoverClass:"qq-upload-button-hover",focusClass:"qq-upload-button-focus"},qq.extend(this._options,t),this._element=this._options.element,qq.css(this._element,{position:"relative",overflow:"hidden",direction:"ltr"}),this._input=this._createInput()},qq.UploadButton.prototype={getInput:function(){return this._input},reset:function(){this._input.parentNode&&qq.remove(this._input),qq.removeClass(this._element,this._options.focusClass),this._input=this._createInput()},_createInput:function(){var t=document.createElement("input");this._options.multiple&&t.setAttribute("multiple","multiple"),t.setAttribute("type","file"),t.setAttribute("name",this._options.name),qq.css(t,{position:"absolute",right:0,top:0,fontFamily:"Arial",fontSize:"118px",margin:0,padding:0,cursor:"pointer",opacity:0}),this._element.appendChild(t);var e=this;return qq.attach(t,"change",function(){e._options.onChange(t)}),qq.attach(t,"mouseover",function(){qq.addClass(e._element,e._options.hoverClass)}),qq.attach(t,"mouseout",function(){qq.removeClass(e._element,e._options.hoverClass)}),qq.attach(t,"focus",function(){qq.addClass(e._element,e._options.focusClass)}),qq.attach(t,"blur",function(){qq.removeClass(e._element,e._options.focusClass)}),window.attachEvent&&t.setAttribute("tabIndex","-1"),t}},qq.UploadHandlerAbstract=function(t){this._options={debug:!1,action:"/upload.php",maxConnections:999,onProgress:function(t,e,n,i){},onComplete:function(t,e,n){},onCancel:function(t,e){}},qq.extend(this._options,t),this._queue=[],this._params=[]},qq.UploadHandlerAbstract.prototype={log:function(t){this._options.debug&&window.console&&console.log("[uploader] "+t)},add:function(t){},upload:function(t,e){var n=this._queue.push(t),i={};qq.extend(i,e),this._params[t]=i,n<=this._options.maxConnections&&this._upload(t,this._params[t])},cancel:function(t){this._cancel(t),this._dequeue(t)},cancelAll:function(){for(var t=0;t<this._queue.length;t++)this._cancel(this._queue[t]);this._queue=[]},getName:function(t){},getSize:function(t){},getQueue:function(){return this._queue},_upload:function(t){},_cancel:function(t){},_dequeue:function(t){var e=qq.indexOf(this._queue,t);this._queue.splice(e,1);var n=this._options.maxConnections;if(this._queue.length>=n){var i=this._queue[n-1];this._upload(i,this._params[i])}}},qq.UploadHandlerForm=function(t){qq.UploadHandlerAbstract.apply(this,arguments),this._inputs={}},qq.extend(qq.UploadHandlerForm.prototype,qq.UploadHandlerAbstract.prototype),qq.extend(qq.UploadHandlerForm.prototype,{add:function(t){t.setAttribute("name","qqfile");var e="qq-upload-handler-iframe"+qq.getUniqueId();return this._inputs[e]=t,t.parentNode&&qq.remove(t),e},getName:function(t){return this._inputs[t].value.replace(/.*(\/|\\)/,"")},_cancel:function(t){this._options.onCancel(t,this.getName(t)),delete this._inputs[t];var e=document.getElementById(t);e&&(e.setAttribute("src","javascript:false;"),qq.remove(e))},_upload:function(t,e){var n=this._inputs[t];if(!n)throw new Error("file with passed id was not added, or already uploaded or cancelled");var i=this.getName(t),o=this._createIframe(t),a=this._createForm(o,e);a.appendChild(n);var s=this;return this._attachLoadEvent(o,function(){s.log("iframe loaded");var e=s._getIframeContentJSON(o);s._options.onComplete(t,i,e),s._dequeue(t),delete s._inputs[t],setTimeout(function(){qq.remove(o)},1)}),a.submit(),qq.remove(a),t},_attachLoadEvent:function(t,e){qq.attach(t,"load",function(){t.parentNode&&(t.contentDocument&&t.contentDocument.body&&"false"==t.contentDocument.body.innerHTML||e())})},_getIframeContentJSON:function(iframe){var doc=iframe.contentDocument?iframe.contentDocument:iframe.contentWindow.document,response;this.log("converting iframe's innerHTML to JSON"),this.log("innerHTML = "+doc.body.innerHTML);try{response=eval("("+doc.body.innerHTML+")")}catch(err){response={}}return response},_createIframe:function(t){var e=qq.toElement('<iframe src="javascript:false;" name="'+t+'" />');
return e.setAttribute("id",t),e.style.display="none",document.body.appendChild(e),e},_createForm:function(t,e){var n=qq.toElement('<form method="post" enctype="multipart/form-data"></form>'),i=qq.obj2url(e,this._options.action);return n.setAttribute("action",i),n.setAttribute("target",t.name),n.style.display="none",document.body.appendChild(n),n}}),qq.UploadHandlerXhr=function(t){qq.UploadHandlerAbstract.apply(this,arguments),this._files=[],this._xhrs=[],this._loaded=[]},qq.UploadHandlerXhr.isSupported=function(){var t=document.createElement("input");return t.type="file","multiple"in t&&"undefined"!=typeof File&&"undefined"!=typeof(new XMLHttpRequest).upload},qq.extend(qq.UploadHandlerXhr.prototype,qq.UploadHandlerAbstract.prototype),qq.extend(qq.UploadHandlerXhr.prototype,{add:function(t){if(!(t instanceof File))throw new Error("Passed obj in not a File (in qq.UploadHandlerXhr)");return this._files.push(t)-1},getName:function(t){var e=this._files[t];return null!=e.fileName?e.fileName:e.name},getSize:function(t){var e=this._files[t];return null!=e.fileSize?e.fileSize:e.size},getLoaded:function(t){return this._loaded[t]||0},_upload:function(t,e){var n=this._files[t],i=this.getName(t);this.getSize(t);this._loaded[t]=0;var o=this._xhrs[t]=new XMLHttpRequest,a=this;o.upload.onprogress=function(e){e.lengthComputable&&(a._loaded[t]=e.loaded,a._options.onProgress(t,i,e.loaded,e.total))},o.onreadystatechange=function(){4==o.readyState&&a._onComplete(t,o)},e=e||{},e.qqfile=i;var s=qq.obj2url(e,this._options.action);o.open("POST",s,!0),o.setRequestHeader("X-Requested-With","XMLHttpRequest"),o.setRequestHeader("X-File-Name",encodeURIComponent(i)),o.setRequestHeader("Content-Type","application/octet-stream"),o.send(n)},_onComplete:function(id,xhr){if(this._files[id]){var name=this.getName(id),size=this.getSize(id);if(this._options.onProgress(id,name,size,size),200==xhr.status){this.log("xhr - server response received"),this.log("responseText = "+xhr.responseText);var response;try{response=eval("("+xhr.responseText+")")}catch(err){response={}}this._options.onComplete(id,name,response)}else this._options.onComplete(id,name,{});this._files[id]=null,this._xhrs[id]=null,this._dequeue(id)}},_cancel:function(t){this._options.onCancel(t,this.getName(t)),this._files[t]=null,this._xhrs[t]&&(this._xhrs[t].abort(),this._xhrs[t]=null)}});