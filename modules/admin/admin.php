...
class admin_ctrl extends Controller
{
  ...
  public function showMainAdmin()
  {
    ...
    foreach ([
      ...
      "{$b}datatables.net-bs/css/dataTables.bootstrap.min.css",
      "{$b}izitoast/dist/css/iziToast.min.css",
    ...
    foreach ([
      ...
      "{$b}datatables.net-bs/js/dataTables.bootstrap.min.js",
      "{$b}izitoast/dist/js/iziToast.min.js",
      "{$b}bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js",
      "{$b}select2/dist/js/select2.full.min.js",
